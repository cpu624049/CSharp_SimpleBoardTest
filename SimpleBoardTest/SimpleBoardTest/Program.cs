...
var connectionString = builder.Configuration.GetConnectionString("ShipDBContext") ?? throw new InvalidOperationException("Connection string 'DefaultConnection' not found.");
